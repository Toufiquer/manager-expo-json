        ...
        <View className="fixed left-0 top-0 z-50 min-h-[88vh] w-full ">
            <View className="flex p-6">
                <View className="flex flex-row items-end justify-between pb-6">
                    <Text
                        ...
                        className="max-w-[85%] text-3xl font-extrabold text-gray-950"
                    >
                        Create Menu
                    </Text>
            ...
            <View className="absolute bottom-[10px] w-full px-4">
                ...
                >
                    <Text
                        style={styles.fontsMulishBlack}
                        className="p-2 text-center text-xl font-extrabold text-white"
                    >
            ...
            <View className="max-w-sm self-center rounded-lg  p-4">
                {errors.root && (
                    <View className="flex flex-row gap-1">
                        <Text className="font-extrabold text-rose-500">
                            Error:{' '}
                        </Text>
                        <Text className="text-rose-500">
                            {errors.root.message}{' '}
