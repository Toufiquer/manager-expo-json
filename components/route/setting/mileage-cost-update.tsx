/*
|-----------------------------------------
| setting up MileageCostUpdate for the App
...
const MileageCostUpdate = ({
    ...
    const onSubmit = (submitData) => {
        ...
        setRender({ ...initDefaultRender, renderMileageData: submitData.data })
        setMileageRenderData(submitData.data)
            ...
            <View className="min-h-[300px] gap-1">
                ...
                {fields.map((curr, index) => (
                    ...
                    >
                        ...
                        <TouchableOpacity
                            onPress={() =>
                                setIsDelete({ idx: index, isOpenUI: true })
                            }
                        >
...
export default MileageCostUpdate
